...
{
    public class RunwayActionTakenController : ApiController
    {
         private Airside_Safety_ProjectEntities asp = new Airside_Safety_ProjectEntities();

        [HttpPost]
        public async Task<IHttpActionResult> UpdateChecklistInformation([FromBody] ActionTakenModel postparams)
        {
